...
namespace UnityLesson_CSharp_Method
{
    internal class Program
    {
        ...
        {
            PrintHelloWorld();
            PrintSomething("Hi World!!!!!!!!!"); // 함수 호출에서 소괄호 안 내용은 매개변수(parameter)라고 함

            bool tmpIsFinished = false;

            tmpIsFinished = PrintSomethingAndReturnIsFinished("testtestest");
        ...
        // 인자 O, 반환 X
        static void PrintSomething(string something) // 함수 정의에서 소괄호 안 내용은 인자(Argument)라고 함
        {
